...
This is the test for the Data Engineer position at TheirStack. You can read more details at https://theirstack.notion.site/Data-Engineer-at-TheirStack-com-1d0885e5e97b8085b4f0c9d22733464b  
...
## Input
This repo contains a Docker compose file to run a ClickHouse database. Run `docker compose up -d` to have it running.
